...
* _include\_path_: An array containing strings with paths that should
  be searched when resolving #include directives.
...
(function(){
  ...
  return function(code, include_path) {
    ...
    for (var i=0; i<include_path.length; i++)
      include_path[i]=String(include_path[i]);
    include_path[i]=null;
